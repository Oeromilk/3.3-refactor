...
console.log('1st Question: ', doSomethingCool);
...
// Put your answer below -------------------------
/* C will be logged, because the variable "z" will be hoisted
above the function and be ran and then the function will run
the log "y".
*/
// -----------------------------------------------
...
console.log(reverseStr("My name is"));
...
// var spanishWord = ["rojo", "blanco", "azul", "verde", "negro"];
// var hexColor = ["#ff0000", "#ffffff", "#0000ff", "#00ff00", "#000000"];
//
// var spanishColor = function(colorName, colorCode) {
//   var combinedColor = {};
//
//   for(var i = 0; i < colorName.length; i++){
//     console.log(colorName);
//     var colors = colorName.indexOf(i);
//       if (combinedColor[colors]){
//         combinedColor[colors]++;
//       } else {
//         combinedColor = 1;
//       }
//
//     for(var j = 0; j < colorCode.length; j++){
//       var codes = colorCode.indexOf(j);
//       console.log(codes);
//       if (combinedColor.colors[codes]){
//         combinedColor.colors[codes]++;
//       } else {
//         combinedColors.colors = 1;
//       }
//     }
//   }
...
// }
//
// console.log(spanishColor(spanishWord, hexColor));
